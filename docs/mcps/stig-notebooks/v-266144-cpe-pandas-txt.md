...
"metadata": {},
"source": [
"# V-266144 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Implement traffic inspection and information flow controls via firewall policies\n",
"\n",
...
"|---|---|---|---|\n",
"| firewall policy | action | must equal 'accept' | /mgmt/tm/security/firewall/policy |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'firewall policy', 'lawful_property': 'action', 'admissible_constraint': \"must equal 'accept'\", 'expected_value': 'accept', 'lawful_source': '/mgmt/tm/security/firewall/policy'}])\n",
"lawful_structure_df\n"
]
},
{
