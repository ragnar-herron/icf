...
"metadata": {},
"source": [
"# V-266095 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Automatically terminate idle administrative sessions within 300 seconds\n",
"\n",
...
"|---|---|---|---|\n",
"| HTTPD configuration | authPamIdleTimeout | must equal 300 | /mgmt/tm/sys/httpd |\n",
"| HTTPD configuration | authPamDashboardTimeout | must equal 'on' | /mgmt/tm/sys/httpd |\n",
"| TMOS global settings | consoleInactivityTimeout | must equal 300 | /mgmt/tm/sys/global-settings |\n",
"| SSHD configuration | inactivityTimeout | must equal 300 | /mgmt/tm/sys/sshd |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'HTTPD configuration', 'lawful_property': 'authPamIdleTimeout', 'admissible_constraint': 'must equal 300', 'expected_value': 300, 'lawful_source': '/mgmt/tm/sys/httpd'}, {'carrier_object': 'HTTPD configuration', 'lawful_property': 'authPamDashboardTimeout', 'admissible_constraint': \"must equal 'on'\", 'expected_value': 'on', 'lawful_source': '/mgmt/tm/sys/httpd'}, {'carrier_object': 'TMOS global settings', 'lawful_property': 'consoleInactivityTimeout', 'admissible_constraint': 'must equal 300', 'expected_value': 300, 'lawful_source': '/mgmt/tm/sys/global-settings'}, {'carrier_object': 'SSHD configuration', 'lawful_property': 'inactivityTimeout', 'admissible_constraint': 'must equal 300', 'expected_value': 300, 'lawful_source': '/mgmt/tm/sys/sshd'}])\n",
"lawful_structure_df\n"
]
},
{
