...
"metadata": {},
"source": [
"# V-266079 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Configure redundant authentication servers for availability and security\n",
"\n",
...
"|---|---|---|---|\n",
"| authentication source configuration | type | must equal 'tacacs' | /mgmt/tm/auth/source |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'authentication source configuration', 'lawful_property': 'type', 'admissible_constraint': \"must equal 'tacacs'\", 'expected_value': 'tacacs', 'lawful_source': '/mgmt/tm/auth/source'}])\n",
"lawful_structure_df\n"
]
},
{
