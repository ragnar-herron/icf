...
"metadata": {},
"source": [
"# V-266155 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: The F5 BIG-IP appliance must terminate all network connections associated with a communications session at the end of the session or after 15 minutes of inactivity.\n",
"\n",
...
"|---|---|---|---|\n",
"| APM access profile | inactivityTimeout | must equal 900 | /mgmt/tm/apm/profile/access |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'APM access profile', 'lawful_property': 'inactivityTimeout', 'admissible_constraint': 'must equal 900', 'expected_value': 900, 'lawful_source': '/mgmt/tm/apm/profile/access'}])\n",
"lawful_structure_df\n"
]
},
{
