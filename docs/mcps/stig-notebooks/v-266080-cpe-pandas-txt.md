...
"metadata": {},
"source": [
"# V-266080 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Run a supported BIG-IP TMOS software version with current security patches\n",
"\n",
...
"|---|---|---|---|\n",
"| BIG-IP TMOS software inventory | Version | observed TMOS version must satisfy the locally encoded support policy | /mgmt/tm/sys/version |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'BIG-IP TMOS software inventory', 'lawful_property': 'Version', 'admissible_constraint': 'observed TMOS version must satisfy the locally encoded support policy', 'expected_value': None, 'lawful_source': '/mgmt/tm/sys/version'}])\n",
"lawful_structure_df\n"
]
},
{
