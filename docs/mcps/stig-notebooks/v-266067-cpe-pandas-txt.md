...
"metadata": {},
"source": [
"# V-266067 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Assign appropriate user roles or access levels to authenticated users\n",
"\n",
...
"|---|---|---|---|\n",
"| authentication user record | partitionAccess | must equal [{'name': 'all-partitions', 'role': 'admin'}] | /mgmt/tm/auth/user |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'authentication user record', 'lawful_property': 'partitionAccess', 'admissible_constraint': \"must equal [{'name': 'all-partitions', 'role': 'admin'}]\", 'expected_value': [{'name': 'all-partitions', 'role': 'admin'}], 'lawful_source': '/mgmt/tm/auth/user'}])\n",
"lawful_structure_df\n"
]
},
{
