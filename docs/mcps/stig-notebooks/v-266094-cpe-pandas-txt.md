...
"metadata": {},
"source": [
"# V-266094 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Use DoD-approved OCSP responders or CRLs for PKI certificate validation\n",
"\n",
...
"|---|---|---|---|\n",
"| OCSP responder configuration | approved_responder_identity | responder configuration must map to a DoD-approved OCSP responder or CRL trust source | /mgmt/tm/apm/aaa/ocsp |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'OCSP responder configuration', 'lawful_property': 'approved_responder_identity', 'admissible_constraint': 'responder configuration must map to a DoD-approved OCSP responder or CRL trust source', 'expected_value': None, 'lawful_source': '/mgmt/tm/apm/aaa/ocsp'}])\n",
"lawful_structure_df\n"
]
},
{
