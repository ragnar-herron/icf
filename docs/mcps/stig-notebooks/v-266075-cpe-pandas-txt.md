...
"metadata": {},
"source": [
"# V-266075 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Generate audit records and send to redundant central syslog servers\n",
"\n",
...
"|---|---|---|---|\n",
"| syslog remote server configuration | remoteServers | must equal [{'name': 'stig_syslog1', 'host': ''}, {'name': 'stig_syslog2', 'host': ''}] | /mgmt/tm/sys/syslog |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'syslog remote server configuration', 'lawful_property': 'remoteServers', 'admissible_constraint': \"must equal [{'name': 'stig_syslog1', 'host': ''}, {'name': 'stig_syslog2', 'host': ''}]\", 'expected_value': [{'name': 'stig_syslog1', 'host': ''}, {'name': 'stig_syslog2', 'host': ''}], 'lawful_source': '/mgmt/tm/sys/syslog'}])\n",
"lawful_structure_df\n"
]
},
{
