...
"metadata": {},
"source": [
"# V-266085 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: Use multifactor authentication (PKI-based) for management logins\n",
"\n",
...
"|---|---|---|---|\n",
"| authentication source configuration | type | must equal 'radius' | /mgmt/tm/auth/source |\n"
]
},
{
"cell_type": "code",
...
" lawful_structure_df = pd.DataFrame([{'carrier_object': 'authentication source configuration', 'lawful_property': 'type', 'admissible_constraint': \"must equal 'radius'\", 'expected_value': 'radius', 'lawful_source': '/mgmt/tm/auth/source'}])\n",
"lawful_structure_df\n"
]
},
{
