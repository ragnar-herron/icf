...
"metadata": {},
"source": [
"# V-266139 SQL-to-Pandas CPE Lifecycle\n",
"\n",
"Requirement: The F5 BIG-IP appliance providing intermediary services for remote access must use FIPS-validated cryptographic algorithms, including TLS 1.2 at a minimum.\n",
"\n",
...
"|---|---|---|---|\n",
"| client SSL profile | tmOptions | must equal ['no-sslv2', 'no-sslv3', 'no-tlsv1', 'no-tlsv1.1'] | /mgmt/tm/ltm/profile/client-ssl |\n"
]
},
{
"cell_type": "code",
